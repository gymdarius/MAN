    ...
    def train(self, num_step):
        ...
        for i in range(num_step):
            ...
            if self.c % self.report_freq == 0:
                ...
                print(f"Step: {self.c}, Reward mean: {reward_mean:.2f}, Reward std: {reward_std:.2f}, Max_height mean: {max_height_mean:.2f}, Max_height std: {max_height_std:.2f}, Bumpiness mean: {bumpiness_mean:.2f}, Bumpiness std: {bumpiness_std:.2f}, Loss_I: {total_loss_V / self.c:.4f}, Loss_II: {total_loss_Q / self.c:.4f}, Eps: {eps:.4f}")
